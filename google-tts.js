/* Modified 01/03/22 by Todd Austin for v2.0.2 of google-tts-api library */
...
class GoogleTTS {
    ...
    static getGoogleTTSUrl(message, lang, index) {
        // Modified by Todd Austin 01/03/22 for version 2.0.2 of google-tts-api library
        return new Promise((resolve) => {
            try {
                const url = googleTTS.getAudioUrl(message, {lang: lang, slow: false, host: 'https://translate.google.com'});
